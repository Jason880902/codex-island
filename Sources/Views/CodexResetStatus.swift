...
struct CodexResetStatus: View {
    ...
    private var shouldShowBadge: Bool {
        // "Visible" now means "assigned to an island slot" — the badge
        // follows Codex to whichever slot the user put it in.
        visibility.effectiveVisible(provider: .codex) && usageStore.codexResetCredits.availableCount > 0
