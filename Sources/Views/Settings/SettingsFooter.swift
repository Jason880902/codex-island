...
struct SettingsFooter: View {
    ...
    private static let githubURL = URL(string: "https://github.com/Jason880902/codex-island")!
    private static let licenseURL = URL(string: "https://github.com/Jason880902/codex-island/blob/main/LICENSE")!
